...
/* --- Source: DATA/js/vendors/jquery-3.7.1.min.js --- */
...
/* --- Source: DATA/js/vendors/jquery-ui.min.js --- */
...
/* --- Source: DATA/js/vendors/bootstrap.bundle.min.js --- */
/*!
...
/* --- Source: DATA/js/vendors/zoom_pan.js --- */
class ZoomPan {
...
/* --- Source: DATA/js/Settings.js --- */
// UNITs
//---------------------------------------------------------------------------------------------------------------

const AZIMUTH_UNITS = 'DEGREES';
// const AZIMUTH_UNITS = 'MILS';

const RANGE_UNITS = 'KM';
// const RANGE_UNITS = 'NMI';

// const VELOCITY_UNITS = 'KNOTS';
const VELOCITY_UNITS = 'MPS';

const ALTITUDE_UNITS = 'KILOFEET';
// const ALTITUDE_UNITS = 'KM';

//REF: TM 9-1430-2535-10, page: 2-54 (130 in the .pdf file), picture: 2-29: UNITS OF MEASURE

// END of UNITs
//---------------------------------------------------------------------------------------------------------------

/* --- Source: DATA/js/Units/UnitsConverter.js --- */
...
/* --- Source: DATA/js/block_elements/Root.js --- */
class Root {
...
/* --- Source: DATA/js/block_elements/MultiSwitch.js --- */
class MultiSwitch extends Root {
  constructor({
    switchId,
    containerId,
    block,
  ...
  goForward() {
    if (this.currentPosition < this.maxPosition) {
      ...
      this.playBeep(); // Play beep when reaching the last image
    }
    this.updateSwitch();
  }
...
/* --- Source: DATA/js/block_elements/RotateButton.js --- */
...
/* --- Source: DATA/js/block_elements/ArmSafeTest.js --- */
...
/* --- Source: DATA/js/block_elements/ToModeSwitch.js --- */
...
/* --- Source: DATA/js/block_elements/TestTarget.js --- */
class TestTarget {
  constructor({
...
/* --- Source: DATA/js/block_elements/JoystickSign.js --- */
class JoystickSign {
  constructor() {
    this.absXPx = 0;
    this.absXPy = 0;
...
/* --- Source: DATA/js/block_elements/TrackDataLabel.js --- */
...
/* --- Source: DATA/js/block_elements/PPI.js --- */
...
/* --- Source: DATA/js/block_elements/PPI_TO.js --- */
...
/* --- Source: DATA/js/block_elements/HorizontalDrag.js --- */
...
/* --- Source: DATA/js/block_elements/AzimuthDrag.js --- */
/**
...
/* --- Source: DATA/js/block_elements/Drag.js --- */
...
/* --- Source: DATA/js/block_elements/Joystick.js --- */
/**
 * Class representing the drag handler for azimuth angle adjustment.
 * Extends from HorizontalDrag class.
 */
...
/* --- Source: DATA/js/block_elements/RangePPI.js --- */
...
/* --- Source: DATA/js/block_elements/TrackDataBtn.js --- */
...
/* --- Source: DATA/js/block_elements/TargetPackage2Ro.js --- */
...
/* --- Source: DATA/js/block_elements/PPITimeAzimuth.js --- */
...
/* --- Source: DATA/js/block_elements/PowerLamp.js --- */
...
/* --- Source: DATA/js/block_elements/PowerTripleSwitch.js --- */
class PowerTripleSwitch extends RotateButton {
  constructor(block) {
    // Define an array of image URLs
    const imagesArray = [
      'DATA/img/triple_switch_off.png',
      'DATA/img/triple_switch_on.png',
    ];

    // Call the parent constructor with the parameters
    super({
      switchId: 'PowerTripleSwitch_id',
      containerId: 'powerBlockId',
      block: null,
      top: 80,
      left: 50,
...
/* --- Source: DATA/js/block_elements/PowerSingleSwitch.js --- */
class PowerSingleSwitch extends RotateButton {
  constructor(block) {
    // Define an array of image URLs
    const imagesArray = [
      'DATA/img/single_switch_off.png',
      'DATA/img/single_switch_on.png',
    ];

    // Call the parent constructor with the parameters
    super({
      switchId: 'PowerSingleSwitch_id',
      containerId: 'powerBlockId',
      block: null,
      top: 80,
      left: 350,
...
/* --- Source: DATA/js/block_elements/SwitchSteel.js --- */
...
/* --- Source: DATA/js/block_elements/PowerIndicator.js --- */
class PowerIndicator extends RotateButton {
  constructor(block) {
    // Define an array of image URLs
    const imagesArray = [
      'DATA/img/power_indicator_bottom.png',
      'DATA/img/power_indicator_bottom.png',
    ];

    // Call the parent constructor with the parameters
    super({
      switchId: 'PowerIndicator_id',
      containerId: 'powerBlockId',
      block: null,
      top: 301,
      left: 194,
...
/* --- Source: DATA/js/block_elements/PowerIndicatorStick.js --- */
...
/* --- Source: DATA/js/BlockTOCommunicationDevice.js --- */
...
/* --- Source: DATA/js/BlockTOStatePanel.js --- */
/** this class represents the block with power switches */
...
/* --- Source: DATA/js/BlockTOPanel.js --- */
/** this class represents the block with power switches */
...
/* --- Source: DATA/js/F1Win/Settings.js --- */
...
/* --- Source: DATA/js/F1Win/F1TabChild.js --- */
